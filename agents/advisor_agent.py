...
MODEL_RATE_LIMIT_COOLDOWN_SEC = int(os.getenv("GEMINI_RATE_LIMIT_COOLDOWN_SEC", "120"))
MODEL_NOTFOUND_COOLDOWN_SEC = int(os.getenv("GEMINI_NOTFOUND_COOLDOWN_SEC", "180"))
